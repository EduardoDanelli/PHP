...
// 2 forma->
//$pdo -> query("INSERT INTO pessoa(nome, telefone, email) Values('Mah', '222111000', 'mah@email.com')");
...
// $update -> bindValue(":e", "Mah@gmail.com");
// $update -> bindValue(":id", 3);
// $update->execute();


//$update = $pdo -> query("UPDATE pessoa SET email = 'maah@email.com' WHERE id = '3'");
